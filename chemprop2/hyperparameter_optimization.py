...
SPACE = {
    ...
    'epochs': hp.quniform('epoch', low=20, high=50, q=10)
}

#INT_KEYS = ['hidden_size', 'depth', 'ffn_num_layers']
INT_KEYS = ['hidden_size', 'depth', 'ffn_num_layers', 'batch_size', 'epochs']
...
def grid_search(args: HyperoptArgs):
    ...
    fmin(objective, SPACE, algo=tpe.suggest, max_evals=args.num_iters, rstate=np.random.RandomState(1))
    # Report best result
